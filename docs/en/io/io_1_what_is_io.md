# 🧙 I/O PROGRAMMING — WIZARD NOTEBOOK

> Goal: Noob → Wizard. CPU → userspace → syscall → kernel → device → DMA → completion/readiness → application.
> Language for all code: **C++** (C++20, POSIX/Linux, GCC/Clang, x86-64).

---

## 📊 My Progress

| Part | Topic | Status | Level |
|---|---|---|---|
| 0 | Fundamentals | 🟨 | 🟢 NOOB |
| 1 | Hardware Foundations | ⬜ | — |
| 2 | Linux Process + Kernel Foundations | ⬜ | — |
| 3 | File Descriptors | ⬜ | — |
| 4 | Blocking I/O | ⬜ | — |
| 5 | Nonblocking I/O | ⬜ | — |
| 6 | select() | ⬜ | — |
...
| 11 | Event Loops | ⬜ | — |
| 12 | kqueue | ⬜ | — |
| 13 | Readiness vs Completion | ⬜ | — |
| 14 | io_uring | ⬜ | — |
| 15 | Filesystem I/O | ⬜ | — |
| 16 | Zero Copy | ⬜ | — |
| 17 | Buffering | ⬜ | — |
| 18 | Vectored I/O | ⬜ | — |
| 19 | Signal-Driven I/O | ⬜ | — |
| 20 | Windows I/O | ⬜ | — |
| 21 | High Performance Networking | ⬜ | — |
| 22 | Performance Engineering | ⬜ | — |
| 23 | Benchmarking | ⬜ | — |
| 24 | Production Architecture | ⬜ | — |
| 25 | Source Code Archaeology | ⬜ | — |
| 26 | I/O Design Patterns | ⬜ | — |
| 27 | Advanced Concurrency + I/O | ⬜ | — |
| 28 | I/O Security | ⬜ | — |
| 29 | Final Comparison / Decision Framework | ⬜ | — |

Legend: ⬜ Not Started · 🟨 Studying · 🟩 Completed · ⭐ Mastered
Levels: 🟢 NOOB · 🔵 BEGINNER · 🟡 INTERMEDIATE · 🟠 ADVANCED · 🔴 PRO · 🟣 LEGEND · ⚫ WIZARD
...
- [ ] What happens inside read()
- [ ] What happens inside write()
- [ ] Why threads solve one problem but create others
- [ ] Why nonblocking I/O exists
- [ ] Why select exists
- [ ] Why poll exists
- [ ] Why epoll exists
- [ ] LT vs ET
...
- [ ] Zero-copy
- [ ] TCP backpressure
- [ ] Event loops / Reactor / Proactor / IOCP
...
### 🐛 Bugs I Have Personally Encountered
-
